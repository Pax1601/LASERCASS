...
function writeSPLINE32file(outf, fid, stick, aircraft, POLY, W, NP, RMAX, TCOND)
%--------------------------------------------------------------------------------------------------
% SPLINE3 card
%
...
if isequal(stick.model.winr, 1)
    ...
    for i = 1:length(stick.IDCAERO1.winr)
        ...
        % Recall function
        BULKdataSPLINE3(fid, ID, IDCAERO1, 1, LPAN, IDSET, POLY, W, NP, RMAX, TCOND);
...
if isequal(stick.model.horr, 1)
    ...
    for i = 1:length(stick.IDCAERO1.horr)
        ...
        % Recall function
        BULKdataSPLINE3(fid, ID, IDCAERO1, 1, LPAN, IDSET, 2);
    end
