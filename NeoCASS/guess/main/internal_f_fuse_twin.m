...
function [int_forces] =internal_f_fuse_twin(forces, state, stick, distances, forces_wing2_dx, forces_wing2_sx, forces_wing_dx,...
                                            forces_wing_sx, forces_htail_dx, forces_htail_sx, aircraft, acc)
...
%% Htail        
    if  isequal(stick.nodes.fuse_thick(1,i)>=stick.nodes.horr_thick(1,1),1)==0
        int_forces_htail.Tx(i,:)=0;
        int_forces_htail.Ty(i,:)=0;
        int_forces_htail.Tz(i,:)=0;
        int_forces_htail.Mx(i,:)=0;
        int_forces_htail.My(i,:)=0;
        int_forces_htail.Mz(i,:)=0;
    else 
        int_forces_htail.Tx(i,:)=forces_htail_dx.Tx(1)+forces_htail_sx.Tx(1);
        int_forces_htail.Ty(i,:)=forces_htail_dx.Ty(1)+forces_htail_sx.Ty(1);
        int_forces_htail.Tz(i,:)=forces_htail_dx.Tz(1)+forces_htail_sx.Tz(1);
        int_forces_htail.Mx(i,:)=forces_htail_dx.Mx(1)+forces_htail_sx.Mx(1);
        int_forces_htail.My(i,:)=forces_htail_dx.My(1)+forces_htail_sx.My(1)+(forces_htail_dx.Tz(1)+forces_htail_sx.Tz(1))*...
                                                                           (Xcg-stick.nodes.horrC2_thick(1,1));

        int_forces_htail.Mz(i,:)=forces_htail_dx.Mz(1)+forces_htail_sx.Mz(1);
...
if isequal(stick.model.canr, 1)
int_forces.Tx=int_forces_fus.Tx+int_forces_can.Tx+int_forces_wing.Tx+int_forces_htail.Tx+int_forces_engines.Tx;
int_forces.Ty=int_forces_fus.Ty+int_forces_can.Ty+int_forces_wing.Ty+int_forces_htail.Ty+int_forces_engines.Ty;
int_forces.Tz=int_forces_fus.Tz+int_forces_can.Tz+int_forces_wing.Tz+int_forces_htail.Tz+int_forces_engines.Tz;
int_forces.Mx=int_forces_fus.Mx+int_forces_can.Mx+int_forces_wing.Mx+int_forces_htail.Mx;
int_forces.My=int_forces_fus.My+int_forces_can.My+int_forces_wing.My+int_forces_htail.My+int_forces_engines.My;
int_forces.Mz=int_forces_fus.Mz+int_forces_can.Mz+int_forces_wing.Mz+int_forces_htail.Mz;
else
int_forces.Tx=int_forces_fus.Tx+int_forces_wing.Tx+int_forces_htail.Tx+int_forces_engines.Tx;
int_forces.Ty=int_forces_fus.Ty+int_forces_wing.Ty+int_forces_htail.Ty+int_forces_engines.Ty;
int_forces.Tz=int_forces_fus.Tz+int_forces_wing.Tz+int_forces_htail.Tz+int_forces_engines.Tz;
int_forces.Mx=int_forces_fus.Mx+int_forces_wing.Mx+int_forces_htail.Mx;
int_forces.My=int_forces_fus.My+int_forces_wing.My+int_forces_htail.My+int_forces_engines.My;
int_forces.Mz=int_forces_fus.Mz+int_forces_wing.Mz+int_forces_htail.Mz;   
end
