...
function [] = BULKdataPBARGFU(fid, PSMID, MID, STHICK, RGEO,...
                              BM, BEXP, NSM, KMG, KP,...
                              C1, C2, D1, D2, E1, E2, F1, F2)

%--------------------------------------------------------------------------
% Define field 1: PBARGFU
fprintf(fid, 'PBARGFU ');
...
%--------------------------------------------------------------------------
% Define field 6: BM buckling m factor
[GD] = cnvt2_8chs(BM);
fprintf(fid, '%c', GD);

%--------------------------------------------------------------------------
% Define field 7: BEXP buckling m factor
[GD] = cnvt2_8chs(BEXP);
fprintf(fid, '%c', GD);
...
%--------------------------------------------------------------------------
% Define field 1: KMG section factor
[GD] = cnvt2_8chs(KMG);
fprintf(fid, '%c', GD);

%--------------------------------------------------------------------------
% Define field 2: KP section factor
[GD] = cnvt2_8chs(KP);
fprintf(fid, '%c', GD);
