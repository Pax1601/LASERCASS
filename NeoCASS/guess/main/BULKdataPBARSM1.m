...
%  PBARSM1    PSMID      MID     AREATOT      IXX       TC       CHORD     HEIGHT     NSM  
...
%   <andreadr@kth.se>
%--------------------------------------------------------------------------------------------------
function [] = BULKdataPBARSM1_mod_mod(fid, PSMID, MID, AREATOT, IXX, TC, CHORD, HEIGHT, NSM, C1, C2, D1, D2, E1, E2, F1, F2)
...
%--------------------------------------------------------------------------
% Define field 4: AREATOT
[AREATOTstr] = cnvt2_8chs(AREATOT);
fprintf(fid, '%c', AREATOTstr);

%--------------------------------------------------------------------------
% Define field 5: IXX
[IXXstr] = cnvt2_8chs(IXX);
fprintf(fid, '%c', IXXstr);
