function[x_corr_sup,y_corr_sup,z_corr_sup,x_corr_inf,y_corr_inf,z_corr_inf,ncorr_sup,ncorr_inf]=stiffener_position_var_rib(vertex_x,vertex_y,vertex_z,x_sup,y_sup,z_sup,x_inf,y_inf,z_inf,ncorr_sup,ncorr_inf,gap_sup,gap_inf,stiff_type)
