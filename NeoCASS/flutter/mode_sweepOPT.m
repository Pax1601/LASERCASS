...
function [FL_DET, risultati, SVTNFL, SVQU, IMODFL, IWAR, NSTOP,FACTOR,PERMUTAZIONE,BASE] = ...
          mode_sweepOPT(nm, Mhh, Chh, Khh, AER, Kfreq, rho, chord, ISWP, IVMODS, OMEP, SVQU, IMODFL);
...
%         COEF(:,1:end-1)=COEF1(:,1:end-1);
    ...
    if (METODO == 3)
        ...
        FACTOR(:,:,ISTEP) = COEF1;
        PERMUTAZIONE(ISTEP,:) = PERM;
        BASE(:,ISTEP) = TN(1:nmodc);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
