...
function [vf, hf] = run_flutter_ffa(strf, aerof, mbase, msw, rho, vrange, plot_req, nfig, nres)
%
%***********************************************************************************************************************
%
...
% 
  [FL_FOUND, res, SVTNFL, SVQU, IMODFL, IVAR, NSTOP] = mode_sweep(n, fl_model.struct.Mhh, fl_model.struct.Chh*fl_model.struct.Khh, ...
                                                         fl_model.struct.Khh, fl_model.aero.Qhh, fl_model.aero.Klist, fl_model.aero.rho, ...
                                                         fl_model.ref.lref, fl_model.struct.SID(n), fl_model.struct.MID, MFreq(index), ...
                                                         SVQU, IMODFL);
%
  if (IVAR)
...
fprintf(fid, '     Divergence found at %g Pa.', Div_P);
%
