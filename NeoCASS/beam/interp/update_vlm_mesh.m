...
function lattice_defo = update_vlm_mesh(NODE, UPD_NODEPOS, UPD_NODER, AERO) 
...
for nID = 1 : length(AERO.ID)
    ...
    for nn = nPT
        N(AERO.lattice_vlm.DOF(nID,nn,1):AERO.lattice_vlm.DOF(nID,nn,2),:) = get_defo_normal( ... 
            ...
            AERO.lattice_vlm.DN(AERO.lattice_vlm.DOF(nID,nn,1):AERO.lattice_vlm.DOF(nID,nn,2),:), ...
            AERO.geo.b(nID));
    end
end
% VORTEX_C = AERO.lattice_vlm.VORTEX;
