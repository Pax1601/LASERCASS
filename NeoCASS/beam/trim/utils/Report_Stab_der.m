...
function Report_Stab_der(file_name, varargin)
...
if nargin == 2 % only rigid Stability derivatives
    SD = varargin{1};
...
%     fprintf(fid,'\n%s','\usepackage[vflt]{floatflt}');
    ...
    fprintf(fid,'\n%s','\begin{tabular}{|l|c|}');
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{L_{\alpha}}$ & ',num2str(SD.Alpha.dcl_dalpha),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{\alpha}}$ & ',num2str(SD.Alpha.dcmm_dalpha),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    % \hspace{10mm}
    % \begin{tabular}{|l|c|}
    % \hline\hline
    % \multicolumn{2}{c}{\textbf{H tail}}\\\hline\hline
    % $c_{root}$ [ft] & 5\\\hline
    ...
    % \begin{tabular}{|l|c|}
    % \hline\hline
    % \multicolumn{2}{c}{\textbf{V tail}}\\\hline\hline
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{\beta}}$ & ',num2str(SD.Beta.dcs_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{L_{\beta}}$ & ',num2str(SD.Beta.dcl_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{\beta}}$ & ',num2str(SD.Beta.dcml_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{\beta}}$ & ',num2str(SD.Beta.dcmm_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{\beta}}$ & ',num2str(SD.Beta.dcmn_dbeta),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    % \hspace{10mm}
    % \begin{tabular}{|l|c|}
    % \hline\hline
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{p}}$ & ',num2str(SD.P_rate.dcs_dP),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{p}}$ & ',num2str(SD.P_rate.dcml_dP),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{p}}$ & ',num2str(SD.P_rate.dcmn_dP),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    % \hspace{10mm}
    % \begin{tabular}{|l|c|}
    % \hline\hline
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{L_{q}}$ & ',num2str(SD.Q_rate.dcl_dQ),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{q}}$ & ',num2str(SD.Q_rate.dcmm_dQ),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    % \hspace{10mm}
    % \begin{tabular}{|l|c|}
    % \hline\hline
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{r}}$ & ',num2str(SD.R_rate.dcs_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{L_{r}}$ & ',num2str(SD.R_rate.dcl_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{r}}$ & ',num2str(SD.R_rate.dcml_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{r}}$ & ',num2str(SD.R_rate.dcmm_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{r}}$ & ',num2str(SD.R_rate.dcmn_dR),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    % \hspace{10mm}
    % \begin{tabular}{|l|c|}
    % \hline\hline
    ...
    for i = 1:length(SD.Control.dcl_dDelta)
        ...
        fprintf(fid,'\n%s','\hline\hline');
        fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
        fprintf(fid,'\n%s',['$C_{S_{\delta_{',name,'}}}$ & ',num2str(SD.Control.dcs_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{L_{\delta_{',name,'}}}$ & ',num2str(SD.Control.dcl_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal L}_{\delta_{',name,'}}}$ & ',num2str(SD.Control.dcml_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal M}_{\delta_{',name,'}}}$ & ',num2str(SD.Control.dcmm_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal N}_{\delta_{',name,'}}}$ & ',num2str(SD.Control.dcmn_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s','\end{tabular}');
        
        fprintf(fid,'\n%s',['\caption{$\delta_{',name,'}$ derivatives}']);
        fprintf(fid,'\n%s',['\label{tab:',beam_model.Res.Aero.RStab_Der.Control.Name{i},'}']);
        fprintf(fid,'\n%s','\end{table}');
    end
...
%     fprintf(fid,'\n%s','\usepackage[vflt]{floatflt}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{L_{\alpha}}$ & ',num2str(RSD.Alpha.dcl_dalpha),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{\alpha}}$ & ',num2str(RSD.Alpha.dcmm_dalpha),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\begin{tabular}{|l|c|}');
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Deformable}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{L_{\alpha}}$ & ',num2str(DSD.Alpha.dcl_dalpha),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{\alpha}}$ & ',num2str(DSD.Alpha.dcmm_dalpha),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\begin{tabular}{|l|c|}');
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{D$/$R}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{L_{\alpha}}$ & ',num2str(DSD.Alpha.dcl_dalpha/RSD.Alpha.dcl_dalpha),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{\alpha}}$ & ',num2str(DSD.Alpha.dcmm_dalpha/RSD.Alpha.dcmm_dalpha),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{\beta}}$ & ',num2str(RSD.Beta.dcs_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{L_{\beta}}$ & ',num2str(RSD.Beta.dcl_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{\beta}}$ & ',num2str(RSD.Beta.dcml_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{\beta}}$ & ',num2str(RSD.Beta.dcmm_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{\beta}}$ & ',num2str(RSD.Beta.dcmn_dbeta),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Deformable}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{\beta}}$ & ',num2str(DSD.Beta.dcs_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{L_{\beta}}$ & ',num2str(DSD.Beta.dcl_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{\beta}}$ & ',num2str(DSD.Beta.dcml_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{\beta}}$ & ',num2str(DSD.Beta.dcmm_dbeta),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{\beta}}$ & ',num2str(DSD.Beta.dcmn_dbeta),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{p}}$ & ',num2str(RSD.P_rate.dcs_dP),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{p}}$ & ',num2str(RSD.P_rate.dcml_dP),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{p}}$ & ',num2str(RSD.P_rate.dcmn_dP),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Deformable}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{p}}$ & ',num2str(DSD.P_rate.dcs_dP),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{p}}$ & ',num2str(DSD.P_rate.dcml_dP),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{p}}$ & ',num2str(DSD.P_rate.dcmn_dP),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{D/R}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{p}}$ & ',num2str(DSD.P_rate.dcs_dP/RSD.P_rate.dcs_dP),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{p}}$ & ',num2str(DSD.P_rate.dcml_dP/RSD.P_rate.dcml_dP),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{p}}$ & ',num2str(DSD.P_rate.dcmn_dP/RSD.P_rate.dcmn_dP),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    fprintf(fid,'\n%s','\caption{$p$ derivatives}');
    fprintf(fid,'\n%s','\label{tab:P}');
    fprintf(fid,'\n%s','\end{table}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{L_{q}}$ & ',num2str(RSD.Q_rate.dcl_dQ),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{q}}$ & ',num2str(RSD.Q_rate.dcmm_dQ),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Deformable}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{L_{q}}$ & ',num2str(DSD.Q_rate.dcl_dQ),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{q}}$ & ',num2str(DSD.Q_rate.dcmm_dQ),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{D/R}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{L_{q}}$ & ',num2str(DSD.Q_rate.dcl_dQ/RSD.Q_rate.dcl_dQ),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{q}}$ & ',num2str(DSD.Q_rate.dcmm_dQ/RSD.Q_rate.dcmm_dQ),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{r}}$ & ',num2str(RSD.R_rate.dcs_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{L_{r}}$ & ',num2str(RSD.R_rate.dcl_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{r}}$ & ',num2str(RSD.R_rate.dcml_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{r}}$ & ',num2str(RSD.R_rate.dcmm_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{r}}$ & ',num2str(RSD.R_rate.dcmn_dR),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    ...
    fprintf(fid,'\n%s','\hline\hline');
    fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Deformable}}\\\hline\hline');
    fprintf(fid,'\n%s',['$C_{S_{r}}$ & ',num2str(DSD.R_rate.dcs_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{L_{r}}$ & ',num2str(DSD.R_rate.dcl_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal L}_{r}}$ & ',num2str(DSD.R_rate.dcml_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal M}_{r}}$ & ',num2str(DSD.R_rate.dcmm_dR),'\\\hline']);
    fprintf(fid,'\n%s',['$C_{{\cal N}_{r}}$ & ',num2str(DSD.R_rate.dcmn_dR),'\\\hline']);
    fprintf(fid,'\n%s','\end{tabular}');
    fprintf(fid,'\n%s','\hspace{10mm}');
    fprintf(fid,'\n%s','\begin{tabular}{|l|c|}');
    fprintf(fid,'\n%s','\hline\hline');
    ...
    for i = 1:length(RSD.Control.dcl_dDelta)
        ...
        fprintf(fid,'\n%s','\hline\hline');
        fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Rigid}}\\\hline\hline');
        fprintf(fid,'\n%s',['$C_{S_{\delta_{',name,'}}}$ & ',num2str(RSD.Control.dcs_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{L_{\delta_{',name,'}}}$ & ',num2str(RSD.Control.dcl_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal L}_{\delta_{',name,'}}}$ & ',num2str(RSD.Control.dcml_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal M}_{\delta_{',name,'}}}$ & ',num2str(RSD.Control.dcmm_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal N}_{\delta_{',name,'}}}$ & ',num2str(RSD.Control.dcmn_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s','\end{tabular}');
        ...
        fprintf(fid,'\n%s','\hline\hline');
        fprintf(fid,'\n%s','\multicolumn{2}{c}{\textbf{Deformable}}\\\hline\hline');
        fprintf(fid,'\n%s',['$C_{S_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcs_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{L_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcl_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal L}_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcml_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal M}_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcmm_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s',['$C_{{\cal N}_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcmn_dDelta(i)),'\\\hline']);
        fprintf(fid,'\n%s','\end{tabular}');
        fprintf(fid,'\n%s','\hspace{10mm}');
        ...
        if abs(DSD.Control.dcs_dDelta(i)/RSD.Control.dcs_dDelta(i))<2 && abs(DSD.Control.dcs_dDelta(i)/RSD.Control.dcs_dDelta(i))>1e-3
            fprintf(fid,'\n%s',['$C_{S_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcs_dDelta(i)/RSD.Control.dcs_dDelta(i)),'\\\hline']);
        else
        ...
        if abs(DSD.Control.dcl_dDelta(i)/RSD.Control.dcl_dDelta(i))<2 && abs(DSD.Control.dcl_dDelta(i)/RSD.Control.dcl_dDelta(i))>1e-3
            fprintf(fid,'\n%s',['$C_{L_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcl_dDelta(i)/RSD.Control.dcl_dDelta(i)),'\\\hline']);
        else
        ...
        if abs(DSD.Control.dcml_dDelta(i)/RSD.Control.dcml_dDelta(i))<2 && abs(DSD.Control.dcml_dDelta(i)/RSD.Control.dcml_dDelta(i))>1e-3
            fprintf(fid,'\n%s',['$C_{{\cal L}_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcml_dDelta(i)/RSD.Control.dcml_dDelta(i)),'\\\hline']);
        else
        ...
        if abs(DSD.Control.dcmm_dDelta(i)/RSD.Control.dcmm_dDelta(i))<2 && abs(DSD.Control.dcmm_dDelta(i)/RSD.Control.dcmm_dDelta(i))>1e-3
            fprintf(fid,'\n%s',['$C_{{\cal M}_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcmm_dDelta(i)/RSD.Control.dcmm_dDelta(i)),'\\\hline']);
        else
        ...
        if abs(DSD.Control.dcmn_dDelta(i)/RSD.Control.dcmn_dDelta(i))<2 && abs(DSD.Control.dcmn_dDelta(i)/RSD.Control.dcmn_dDelta(i))>1e-3
            fprintf(fid,'\n%s',['$C_{{\cal N}_{\delta_{',name,'}}}$ & ',num2str(DSD.Control.dcmn_dDelta(i)/RSD.Control.dcmn_dDelta(i)),'\\\hline']);
        else
