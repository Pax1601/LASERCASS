function [r,J] = MyIdentification_RightMFD_LinIncr_Fun_4LM(thetaold,ord,p,H,H0,weight,ro)
% =========================================================================
%                                 MyIdentification_RightMFD_LinIncr_Fun_4LM
% =========================================================================
%
...
% -------------------------------------------------------------------------
[D,N] = extractmatrices( 'right', 'lin', thetaold, H0, ordD, ordN );
